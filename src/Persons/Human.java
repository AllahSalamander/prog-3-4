...
public class Human extends Person implements Creature {
    ...
    public String goToShip() {
        return this.getName() + " сел на корабль";
    }
    ...
    public String goHome() {
        return this.getName() + " отправляется домой";
    }

    @Override
    public String goToWork() {
        if (this.getValuable() >= 500) {
    ...
    @Override
    public String tell() {
        return "Привет, меня зовут " + this.getName() + ", у меня на балансе: " + this.getValuable();
    }
